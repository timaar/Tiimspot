...
import com.timaar.tiimspot.service.MailService;
import com.timaar.tiimspot.service.UserService;
import com.timaar.tiimspot.web.rest.dto.KeyAndPasswordDTO;
...
public class AccountResource {
    ...
    public ResponseEntity<String> saveAccount(@RequestBody UserDTO userDTO) {
        return userRepository
            ...
            .map(u -> {
                userService.updateUserInformation(userDTO.getOuderVoornaam(), userDTO.getOuderNaam(), userDTO.getEmail(),
                    userDTO.getLangKey());
